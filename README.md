...
- [kubevirt](https://github.com/kubevirt/kubevirt): Runs virtual machines as Kubernetes workloads, with [CDI](https://github.com/kubevirt/containerized-data-importer) importing their disk images.
